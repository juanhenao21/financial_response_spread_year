...
def taq_save_data(function_name, data, ticker_i, ticker_j, year, month, day):
    ...
    if (not os.path.isdir('../../taq_data/transactions_responses_data_{1}/{0}/'
                          .format(function_name, year))):

        try:

            os.mkdir('../../taq_data/transactions_responses_data_{1}/{0}/'
                     .format(function_name, year))
    ...
    if (ticker_i != ticker_j):
        ...
        pickle.dump(data, open(''.join((
            '../../taq_data/transactions_responses_data_{3}/{0}/{0}_{3}{4}{5}'
        ...
        pickle.dump(data, open(''.join((
            '../../taq_data/transactions_responses_data_{2}/{0}/{0}_{2}{3}{4}'
            '_{1}.pickle').split())
...
def taq_save_plot(function_name, figure, ticker_i, ticker_j, year, month):
    ...
    if (not os.path.isdir('../../taq_plot/transactions_responses_plot_{1}/{0}/'
                          .format(function_name, year))):

        try:

            os.mkdir('../../taq_plot/transactions_responses_plot_{1}/{0}/'
                     .format(function_name, year))
            print('Folder to save data created')
    ...
    if (ticker_i != ticker_j):
        ...
        figure.savefig(
            '../../taq_plot/transactions_responses_plot_{3}/{0}/{0}_{3}{4}_{1}i_{2}j.png'
            .format(function_name, ticker_i, ticker_j, year, month))

    else:

        figure.savefig(
            '../../taq_plot/transactions_responses_plot_{2}/{0}/{0}_{2}{3}_{1}.png'
