...
def midpoint_data(ticker, day):
    ...
    data = np.genfromtxt(gzip.open('../../ITCH_2016/201603%s_%s.csv.gz' %
                         (day, ticker)), dtype='str', skip_header=1,
                         delimiter=',')
    ...
    pickle.dump(bestAsks_first_val,
                open('../Data/midpoint_data/bestAsks_201603%s_%s.pickl' %
                     (day, ticker), 'wb'))
    pickle.dump(bestBids_first_val,
                open('../Data/midpoint_data/bestBids_201603%s_%s.pickl' %
                     (day, ticker), 'wb'))
    pickle.dump(spread_first_val,
                open('../Data/midpoint_data/spread_201603%s_%s.pickl' %
                     (day, ticker), 'wb'))
    pickle.dump(full_time, open('../Data/midpoint_data/time.pickl', 'wb'))
    pickle.dump(midpoint_first_val,
                open('../Data/midpoint_data/midpoint_201603%s_%s.pickl' %
                     (day, ticker), 'wb'))
...
def trade_signs_data(ticker, day):
    ...
    pickle.dump(trade_signs_complete_most, open(
                '../Data/trade_signs_data/trade_signs_most_201603%s_%s.pickl'
                % (day, ticker), 'wb'))
