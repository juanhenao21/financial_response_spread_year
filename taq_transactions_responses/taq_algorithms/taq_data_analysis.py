...
def taq_cross_response_day_transactions_responses_data(ticker_i, ticker_j, date, shift):
    """
    ...
    if (ticker_i == ticker_j):
        ...
        try:
            ...
            function_name = taq_cross_response_day_transactions_responses_data.__name__
