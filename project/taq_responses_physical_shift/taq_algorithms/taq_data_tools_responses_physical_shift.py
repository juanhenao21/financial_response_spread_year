...
def taq_save_data(function_name, data, ticker_i, ticker_j, year, month, day):
    ...
    taq_data_analysis_responses_physical_shift module in pickle files.
    ...
    if (not os.path.isdir(f'../../taq_data/responses_physical_shift_data'
                          + f'_{year}/{function_name}/')):

        try:
            os.mkdir(f'../../taq_data/responses_physical_shift_data_{year}/'
                     + f'{function_name}/')
    ...
    if (ticker_i != ticker_j):
        ...
        pickle.dump(data, open(
            f'../../taq_data/responses_physical_shift_data_{year}/'
            + f'{function_name}/{function_name}_{year}{month}{day}_{ticker_i}i'
            + f'_{ticker_j}j.pickle', 'wb'))
    ...
    # Self-response data
        ...
        pickle.dump(data, open(
            f'../../taq_data/responses_physical_shift_data_{year}/'
            + f'{function_name}/{function_name}_{year}{month}{day}_{ticker_i}'
            + f'.pickle', 'wb'))
...
def taq_save_plot(function_name, figure, ticker_i, ticker_j, year, month):
    ...
    taq_data_plot_responses_physical_shift module in png files.
    ...
    if (not os.path.isdir(f'../../taq_plot/responses_physical_shift_plot'
                          + f'_{year}/{function_name}/')):

        try:
            os.mkdir(f'../../taq_plot/responses_physical_shift_plot_{year}/'
                     + f'{function_name}/')
            print('Folder to save data created')
    ...
    if (ticker_i != ticker_j):
        ...
        figure.savefig(f'../../taq_plot/responses_physical_shift_plot_{year}'
...
def taq_initial_data():
    ...
    print()
    print('###############################################')
    print('Response Functions Physical Time Shift Analysis')
    print('###############################################')
    print('AG Guhr')
    ...
    cond = True
    while (cond):
        print('Do you want to add a shift value? (yes/no)')
        res = input()
