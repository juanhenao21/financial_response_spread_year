...
import taq_data_analysis_responses_time_trades_minute
import taq_data_plot_responses_time_trades_minute
...
def taq_data_plot_generator(tickers, year, taus):
    ...
    with mp.Pool(processes=mp.cpu_count()) as pool:
        pool.starmap(
            taq_data_plot_responses_time_trades_minute
            .taq_self_response_year_avg_responses_time_trades_minute_plot,
