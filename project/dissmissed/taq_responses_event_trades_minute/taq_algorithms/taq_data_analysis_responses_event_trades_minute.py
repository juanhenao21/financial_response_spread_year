...
def main():
    ...
    # taq_self_response_year_avg_responses_event_trades_minute_data(ticker, year, tau)
    taq_cross_response_year_avg_responses_event_trades_minute_data(ticker_i, ticker_j, year, tau)
