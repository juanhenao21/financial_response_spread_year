...
def taq_save_data(function_name, data, ticker_i, ticker_j, year, month, day):
    ...
    if (not os.path.isdir(
        '../../taq_data/responses_time_trades_minute_data_{1}/{0}/'
    ...
    if (ticker_i != ticker_j):
        ...
        pickle.dump(data, open(''.join((
            '../../taq_data/responses_time_trades_minute_data_{3}/{0}/{0}'
    ...
    # Self-response data
        ...
        pickle.dump(data, open(''.join((
            '../../taq_data/responses_time_trades_minute_data_{2}/{0}/{0}'
...
def taq_save_plot(function_name, figure, ticker_i, ticker_j, year, month):
    ...
    if (not os.path.isdir(
        '../../taq_plot/responses_time_trades_minute_plot_{1}/{0}/'
            .format(function_name, year))):
    ...
    if (ticker_i != ticker_j):
        ...
        figure.savefig(''.join((
                       '../../taq_plot/responses_time_trades_minute_plot_{3}'
    ...
    # Self-response data
        ...
        figure.savefig(''.join((
                       '../../taq_plot/responses_time_trades_minute_plot_{2}'
...
def taq_start_folders(year):
    ...
    try:
        os.mkdir('../../taq_data/responses_time_trades_minute_data_{}'
                 .format(year))
        os.mkdir('../../taq_plot/responses_time_trades_minute_plot_{}'
                 .format(year))
        print('Folder to save data created')
