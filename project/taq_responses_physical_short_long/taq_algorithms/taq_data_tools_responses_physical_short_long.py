...
def taq_save_data(function_name, data, ticker_i, ticker_j, year, month, day):
    ...
    taq_data_analysis_responses_time_short_long module in pickle files.
    ...
    if (not os.path.isdir(
        '../../taq_data/responses_time_short_long_data_{1}/{0}/'
            .format(function_name, year))):

        try:
            os.mkdir('../../taq_data/responses_time_short_long_data_{1}/{0}/'
                     .format(function_name, year))
    ...
    if (ticker_i != ticker_j):
        ...
        pickle.dump(data, open(''.join((
            '../../taq_data/responses_time_short_long_data_{3}/{0}/{0}'
    ...
    # Self-response data
        ...
        pickle.dump(data, open(''.join((
            '../../taq_data/responses_time_short_long_data_{2}/{0}/{0}'
...
def taq_save_plot(function_name, figure, ticker_i, ticker_j, year, month):
    ...
    taq_data_plot_responses_time_short_long module in png files.
    ...
    if (not os.path.isdir(
        '../../taq_plot/responses_time_short_long_plot_{1}/{0}/'
            .format(function_name, year))):

        try:
            os.mkdir('../../taq_plot/responses_time_short_long_plot_{1}/{0}/'
                     .format(function_name, year))
            print('Folder to save data created')
    ...
    if (ticker_i != ticker_j):
        ...
        figure.savefig(''.join((
            '../../taq_plot/responses_time_short_long_plot_{3}/{0}/{0}_{3}{4}'
    ...
    # Self-response data
        ...
        figure.savefig(''.join((
            '../../taq_plot/responses_time_short_long_plot_{2}/{0}/{0}_{2}{3}'
            + '_{1}i.png').split())
...
def taq_start_folders(year):
    ...
    try:
        os.mkdir('../../taq_data/responses_time_short_long_data_{}'
                 .format(year))
        os.mkdir('../../taq_plot/responses_time_short_long_plot_{}'
                 .format(year))
        print('Folder to save data created')
