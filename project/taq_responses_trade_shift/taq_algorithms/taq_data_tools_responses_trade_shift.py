...
def taq_save_data(function_name, data, ticker_i, ticker_j, year, month, day):
    ...
    taq_data_analysis_responses_trade_shift module in pickle files.
    ...
    if (not os.path.isdir(f'../../taq_data/responses_trade_shift_data_{year}/'
                          + f'{function_name}/')):

        try:
            os.mkdir(f'../../taq_data/responses_trade_shift_data_{year}/'
                     + f'{function_name}/')
    ...
    if (ticker_i != ticker_j):
        ...
        pickle.dump(data, open(
            f'../../taq_data/responses_trade_shift_data_{year}/{function_name}'
...
def taq_save_plot(function_name, figure, ticker_i, ticker_j, year, month):
    ...
    taq_data_plot_responses_trade_shift module in png files.
    ...
    if (not os.path.isdir(f'../../taq_plot/responses_trade_shift_plot_{year}/'
                          + f'{function_name}/')):

        try:
            os.mkdir(f'../../taq_plot/responses_trade_shift_plot_{year}/'
                     + f'{function_name}/')
            print('Folder to save data created')
    ...
    if (ticker_i != ticker_j):
        ...
        figure.savefig(
            f'../../taq_plot/responses_trade_shift_plot_{year}/{function_name}'
