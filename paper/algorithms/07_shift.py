...
def taq_trade_scale_shift_year_avg_plot(ticker_i, ticker_j, year,
    ...
    try:
        ...
        ax5.set_xlabel(r'Trade shift [s]', fontsize=20)
        ax5.set_ylabel(r'$R^{trades}_{ij}(\tau)$', fontsize=20)
        ...
        # ax1.set_title(r'$\tau$ = {}'.format(tau_val), fontsize=20)
        ax6.set_xlabel(r'Trade shift [s]', fontsize=20)
        ...
        # ax1.set_title(r'$\tau$ = {}'.format(tau_val), fontsize=20)
        ax7.set_xlabel(r'Trade shift [s]', fontsize=20)
        ...
        # ax1.set_title(r'$\tau$ = {}'.format(tau_val), fontsize=20)
        ax8.set_xlabel(r'Trade shift [s]', fontsize=20)
        ...
        # Save plot
        figure.savefig('../plot/07_shift_trade.png')
...
def taq_time_scale_shift_year_avg_plot(ticker_i, ticker_j, year,
    ...
    if (ticker_i == ticker_j):
        ...
        try:
            figure, axs = plt.subplots(2, len(taus), figsize=(16, 9),
            ...
            ax1.legend(loc='upper left', fontsize=15)
            # ax.set_title(r'$\tau$ = {}'.format(tau_val), fontsize=20)
            ax1.set_ylabel(r'$R^{seconds}_{ii}(\tau)$', fontsize=20)
            ax1.tick_params(axis='y', labelsize=15)
            ax1.ticklabel_format(style='sci', axis='y', scilimits=(0, 0))
            ax1.yaxis.offsetText.set_fontsize(15)
            ax1.grid(True)
            ...
            ax5.set_ylabel(r'$R^{seconds}_{ij}(\tau)$', fontsize=20)
            ax5.tick_params(axis='x', labelsize=15)
            ax5.tick_params(axis='y', labelsize=15)
            ax5.ticklabel_format(style='sci', axis='y', scilimits=(0, 0))
            ax5.yaxis.offsetText.set_fontsize(15)
            ...
            # Save plot
            figure.savefig('../plot/07_shift_time.png')
...
def taq_trade_scale_responses_year_avg_shift_plot(ticker_i, ticker_j, year,
    ...
    try:
        ...
        for shift in shifts:
            ...
            ax2.semilogx(cross_event, linewidth=5, label='Shift {} s'
                         .format(shift))
        ...
        # Save plot
        figure.savefig('../plot/07_shift_responses_trades.png')
...
def taq_time_scale_responses_year_avg_shift_plot(ticker_i, ticker_j, year,
    ...
    try:
        ...
        ax2.set_title('{} - {}'.format(ticker_i, ticker_j), fontsize=40)
        ax2.set_xlabel(r'$\tau \, [s]$', fontsize=20)
        ax2.set_ylabel(r'$R^{seconds}_{ij}(\tau)$', fontsize=20)
        ax2.set_xlim(1, 10000)
        ...
        # Save plot
        figure.savefig('../plot/07_shift_responses_time.png')
