...
However, it is still unclear, how the details of the price response definition
...
that the results are qualitatevily the same for two different definitions of
time scale, but the response can vary by up to a factor of two.
