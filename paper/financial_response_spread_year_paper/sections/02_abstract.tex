...
market and find that the results are qualitatively the same for two different
...
returns, displaying the changes in the signal strength. Moreover, we confirm
the dominating contribution of immediate price response directly after a trade,
as we find that delayed responses are suppressed. Finally, we test the impact of
