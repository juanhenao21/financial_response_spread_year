...
In Ref. \cite{referee}, local Gaussian correlations in financial and commodity
markets were analyzed. These correlations distinguish between positive and
negative local dependence. In this work, a breakpoint in August 2008 is found.
The	increased comovements between commodities and financial markets	are	more
critical after the breakpoint, not only between commodities and the S\&P500 and
10-year Treasuries, but also within commodities themselves.
