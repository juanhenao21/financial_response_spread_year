...
defined as
\cite{subtle_nature,Bouchaud_2004,large_prices_changes,em_stylized_facts,prop_order_book,stat_theory}
...
midpoint of that second in $0.007\%$), hence it can give us representative
information on the response functions.
...
second. According to \cite{Wang_2016_cross}, this definition has an average
...
\begin{equation}\label{eq:Bouchaud_2004}
    ...
    - S \left(t, n\right)\right) \cdot \varepsilon^{t} \left(t, n\right)
    \right\rangle_{t}
\end{equation}
...
\begin{equation}\label{eq:dissecting_cross}
    ...
    \right] \cdot \varepsilon_{j}(t) \right\rangle_{p}
\end{equation}
...
Finally, in \cite{Wang_2018_b}, Wang et al. define the response function as
