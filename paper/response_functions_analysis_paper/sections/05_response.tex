...
\begin{figure*}[htbp]
    ...
    \caption{Self- and cross-response functions
             $R^{trade}_{ij}\left(\tau\right)$ excluding
             $\varepsilon^{trade}_{j}\left(t\right) = 0$ in 2008 versus time
...
\begin{figure*}[htbp]
    \centering
    \includegraphics[width=\textwidth]
    {figures/03_responses_time_scale_2008.png}
...
In Figure \ref{fig:relation_responses_self-response}, we can see how the three
responses have the same shape, but the strength of the signal varies depending
on the definition. The frequency of trades have a large influence in the
responses.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\columnwidth]
    {figures/03_self_response_comparison_2008.png}
    \caption{Self-response}
    \label{fig:relation_responses_self-response}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]
    {figures/03_cross_response_comparison_2008.png}
    \caption{Self- and cross-response functions
             ...
             Corp. stocks.}
    \label{fig:relation_responses_cross-response}
\end{figure}
