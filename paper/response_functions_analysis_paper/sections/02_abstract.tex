...
signs and returns is lost. Finally, we analyzed the impact of the time lag in
the response functions. We divided the time lag in an immediate and late
component and compute the self- and cross-response. The influence of the
immediate time lag is larger than the late time lag.
\PACS{
