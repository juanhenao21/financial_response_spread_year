...
\begin{figure*}[htbp]
    ...
    \caption{Self-response functions $R_{ii}^{t}\left(\tau\right)$ excluding
             ...
             the Transocean Ltd.-Apache Corp. stocks (bottom).}
...
\begin{figure*}[htbp]
    ...
    \caption{Self- and cross-response functions $R^{t}_{ij}\left(\tau\right)$
             ...
             time lag $\tau$ on a logarithmic scale for different shifts.
             Self-responses for the Transocean Ltd. stock in trade time
             scale (left), and cross-response of Transocean Ltd.-Apache Corp.
             stocks in trade time scale (right).}
...
\begin{figure*}[htbp]
    ...
    \caption{Self- and cross-response functions $R^{p}_{ij}\left(\tau\right)$
             ...
             time lag $\tau$ on a logarithmic scale for different shifts.
             Self-responses for the Transocean Ltd. stock in physical time
             scale (left), and cross-response of Transocean Ltd.-Apache Corp.
             stocks in physical time scale (right).}
