...
value of the previous second (vertical line over the second interval). Thus,
all the seconds in the open market time have a midpoint price value, and in
consequence returns values. We assume that as there was not a change in the
...
it can give us valuable information about the response functions.
